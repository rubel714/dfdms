...
import SurveyTitleEntry from "./SurveyTitleEntry";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "surveytitleentry"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <SurveyTitleEntry {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
