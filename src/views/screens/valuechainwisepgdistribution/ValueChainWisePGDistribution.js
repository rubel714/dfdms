...
const ValueChainWisePGDistribution = (props) => {
  const serverpage = "valuechainwisepgdistribution"; // this is .php server page
  ...
  const PrintPDFExcelExportFunction = (reportType) => {
    let finalUrl = EXCEL_EXPORT_URL + "report/value_chain_wise_pg_distribution_excel.php";
...
export default ValueChainWisePGDistribution;