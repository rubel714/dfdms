...
import VenueAddEditModal from "./VenueAddEditModal";

const Venue = (props) => {
  const serverpage = "venue"; // this is .php server page
  ...
  return (
    <>
      ...
      {showModal && (<VenueAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback}/>)}
