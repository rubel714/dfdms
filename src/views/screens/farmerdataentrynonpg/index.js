...
import FarmerDataEntryNonPG from "./FarmerDataEntryNonPG";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "farmerdataentrynonpg"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <FarmerDataEntryNonPG {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
