...
import DatatypeQuestionsMap from "./DatatypeQuestionsMap";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "datatypequestionsmap"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <DatatypeQuestionsMap {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
