...
import RegularBeneficiaryEntry from "./RegularBeneficiaryEntry";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "regularbeneficiaryentry"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <RegularBeneficiaryEntry {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
