...
const TotalHouseholdInformation = (props) => {
  const serverpage = "totalhouseholdinformation"; // this is .php server page
  ...
  const PrintPDFExcelExportFunction = (reportType) => {
    ...
    window.open(
      finalUrl +
        "?action=TotalHouseholdInformationExport" +
        "&reportType=excel" +
  ...
  return (
    <>
      <div class="subContainer inputAreaMobile">
        ...
        <div class="topHeader">
          <h4>
            Home ❯ Reports ❯ Total Household Information
          </h4>
        </div> 
...
export default TotalHouseholdInformation;