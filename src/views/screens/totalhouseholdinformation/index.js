...
import TotalHouseholdInformation from "./TotalHouseholdInformation";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "totalhouseholdinformation"; // this is in t_menu table
      ...
      <div >
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <TotalHouseholdInformation {...props} openNoticeModal={openNoticeModal} />
            )}
          ></Route>
        </Switch>
        <Notification
