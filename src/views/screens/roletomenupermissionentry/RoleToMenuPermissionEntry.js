...
const RoleToMenuPermissionEntry = (props) => {
  const serverpage = "roletomenupermissionentry"; // this is .php server page
  ...
  const masterColumnList = [
    { field: "bChecked", label: "bChecked", visible: false, align: "center" },
...
export default RoleToMenuPermissionEntry;
